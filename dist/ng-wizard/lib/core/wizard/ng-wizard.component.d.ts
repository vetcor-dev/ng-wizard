...
export declare class NgWizardComponent implements OnDestroy, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgWizardComponent, "ng-wizard", never, { "pConfig": { "alias": "config"; "required": false; }; }, { "stepChanged": "stepChanged"; "themeChanged": "themeChanged"; "reseted": "reseted"; }, ["steps"], ["*"], false, never>;
}
